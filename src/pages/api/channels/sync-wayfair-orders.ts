...
import { syncWayfairOrdersForTenant, summarize } from '@/lib/syncOrders';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const result = await syncWayfairOrdersForTenant(callerClient, tenantId);
