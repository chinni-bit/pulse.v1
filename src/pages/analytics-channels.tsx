...
// Local calendar-day bucketing throughout - the DB stores timezone-naive
// timestamps, so UTC-based date math (toISOString etc.) merges genuinely
// different local days into one bucket. Learned the hard way on the Sales
// Analytics page; applying the fix here from the start.
